...
const sections = [
   {
    ...
    imageUrl: '/hero1.jpg',
    imageAlt: 'Tesla Model Y driving on a road with mountains in the background',
    imageHint: 'tesla model y silver road mountains driving',
    orderLink: '/model-y/customize',
    learnMoreLink: '#',
  ...
  },
  {
    ...
    imageUrl: '/hero2.jpg',
    imageAlt: 'Tesla Cybertruck driving on a desert road',
    imageHint: 'tesla cybertruck silver desert road driving',
